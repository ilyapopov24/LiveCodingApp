...
from spaceweb_mcp_server import SpacewebMCPServer
...
class SpacewebKeepaliveServer:
    """Keepalive сервер для Spaceweb MCP"""
    
    def __init__(self):
        self.mcp_server = SpacewebMCPServer()
        logger.info("Spaceweb MCP Keepalive Server инициализирован")
            ...
            if method == "initialize":
                ...
                response = {
                    ...
                    "result": {
                        ...
                        "serverInfo": {"name": "Spaceweb VPS MCP", "version": "1.0.0"}
                    }
                }
    ...
    def run(self):
        ...
        logger.info("Spaceweb MCP сервер запущен")
        ...
        try:
            ...
            logger.info("Spaceweb MCP сервер завершен")

if __name__ == "__main__":
    server = SpacewebKeepaliveServer()
    server.run()
