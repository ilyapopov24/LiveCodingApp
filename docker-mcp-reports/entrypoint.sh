...
case "$1" in
    ...
    "spaceweb")
        ...
        ;;
    "http-bridge")
        echo "Запуск HTTP Bridge сервера..."
        exec python src/http_server.py
        ;;
    *)
        echo "Использование: $0 {mcp|mcp-ai|report|ai-test|python-runner|spaceweb|http-bridge}"
        ...
        echo "  http-bridge   - HTTP Bridge для Android приложения"
        exit 1
        ;;
esac
